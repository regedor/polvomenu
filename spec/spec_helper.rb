...
def fixtures_folder(string_path, options={})
  ...
  rootdirs = [ 
    {'rootdir1' => [
      ...
      {'dir3' => [], :items_for_parent => { :title=>"This is an exec.bash inside rootdir1/dir3", :priority=>0,:os=>"ubuntu", :type=>"script", :path=>"./dir3/exec.bash", :rootdir=>"spec/fixtures/rootdir1", :desc => nil }}
    ], :items_for_parent => { :title=>"dir1", :type=>"dir", :path=>"./dir1", :rootdir=>"spec/fixtures/rootdir1" }},
    {'rootdir2' => [
      ...
      {'dir4' => [], :items_for_parent => {:title=>"This is an info.menu in rootdir2/dir4", :priority=>0, :os=>"all", :type=>"dir", :path=>"./dir4", :rootdir=>"spec/fixtures/rootdir2", :desc => nil}},
